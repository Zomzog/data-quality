...
NEXUS_LINK_FOR_DOWNLOAD=$NEXUS_SNAPSHOT_LINK
...
do   
  ...
  sed -i '' -e 's/<artifactId>.*<\/artifactId>/<artifactId>'$element-${DQ_LIB_VERSION}'<\/artifactId>/g' \
